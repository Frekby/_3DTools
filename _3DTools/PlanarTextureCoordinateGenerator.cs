...
// Type: _3DTools.PlanarTextureCoordinateGenerator
...
namespace _3DTools
{
    ...
    {
        public override object Convert(MeshGeometry3D mesh, Vector3D dir) => (object) MeshUtils.GeneratePlanarTextureCoordinates(mesh, dir);
    }
}